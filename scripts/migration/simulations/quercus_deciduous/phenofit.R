...
# Model setup
sim_dir_qrobur <- "E:/USERS/VanderMeersch/data/simulations/phenofit/paleo/025deg/expert/quercus_robur"
sim_dir_qpetraea <- "E:/USERS/VanderMeersch/data/simulations/phenofit/paleo/025deg/expert/quercus_petraea"
output_dir <- file.path(wd, "quercus_deciduous", "output", 
                        paste0("expandLDD_scprb_2km20km_fullmodel_from", starting_year), "phenofit")
save_dir <- file.path("E:/USERS/VanderMeersch/data/simulations", "phenofit", "paleo/migration/expert",
                      paste0("quercus_deciduous", "_expandLDD_scprb_2km20km_fullmodel_from", starting_year))

# Species parameter
best_threshold_qrobur <- 0.70
best_threshold_qpetraea <- 0.65
