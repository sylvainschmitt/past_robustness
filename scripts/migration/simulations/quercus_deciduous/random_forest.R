...
# Model setup
sim_dir_qrobur <- "E:/USERS/VanderMeersch/data/simulations/csdm/random_forest/paleo/025deg/quercus_robur"
sim_dir_qpetraea <- "E:/USERS/VanderMeersch/data/simulations/csdm/random_forest/paleo/025deg/quercus_petraea"
output_dir <- file.path(wd, "quercus_deciduous", "output", 
                        paste0("expandLDD_scprb_2km20km_fullmodel_from", starting_year), "random_forest")
save_dir <- file.path("E:/USERS/VanderMeersch/data/simulations", "csdm", "random_forest", "paleo/migration",
                      paste0("quercus_deciduous", "_expandLDD_scprb_2km20km_fullmodel_from", starting_year))

# Species parameter
best_threshold_qrobur <- 0.518
best_threshold_qpetraea <- 0.612
