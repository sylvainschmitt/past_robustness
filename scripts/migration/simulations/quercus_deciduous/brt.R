...
# Model setup
sim_dir_qrobur <- "E:/USERS/VanderMeersch/data/simulations/csdm/brt/paleo/025deg/quercus_robur"
sim_dir_qpetraea <- "E:/USERS/VanderMeersch/data/simulations/csdm/brt/paleo/025deg/quercus_petraea"
...
# Species parameter
best_threshold_qrobur <- 0.507
best_threshold_qpetraea <- 0.465
