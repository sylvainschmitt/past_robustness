...
#
MigClimCustom2.migrate <- function (iniDist="InitialDist", hsMap="HSmap", rcThreshold=0, 
                             ...
                             testMode=FALSE, fullOutput=FALSE, keepTempFiles=FALSE)
{
  ...
  if(dispSteps<1 | dispSteps > 250) stop("'dispSteps' must be a number in the range [1:250]. \n")
