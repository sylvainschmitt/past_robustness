...
```{r figS10_SDMclass, fig.height = 75, fig.width = 160, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Sensitivity, difference across models.", eval = F}
...
```{r figSX_refugia, fig.height = 240, fig.width = 122, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Refugia.", eval = F}
...
```{r trend_comparison, fig.height = 60, fig.width = 100, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Evolution of climatic dissimilarity under past (12k-11.5k yr BP) and future (2020-2100) climate changes, relative to 1901-2000}.", eval = F}

source(file.path(wd, "manuscript", "figs", "suppmat", "old", "warming_comparison.R"))
comparison
...
```{r load_performance_figS15, fig.height = 120, fig.width = 190, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Beta regression and boxplots", eval = F}

start_year <- "11,000"
source(file.path(wd, "manuscript", "processing", "suppmat", "model_simulations_from11000.R"))
model_performance_withmig$clim_hpv_sorensen.mean <- 1-model_performance_withmig$clim_hpv_sorensen.mean # dissimilarity
...
start_year <- "11,250"
source(file.path(wd, "manuscript", "processing", "suppmat", "model_simulations_from11250.R"))
model_performance_withmig$clim_hpv_sorensen.mean <- 1-model_performance_withmig$clim_hpv_sorensen.mean # dissimilarity
source(file.path(wd, "manuscript", "figs", "suppmat", "figS15", "boxplot_performance.R"))
boxplot_from11250 <- boxplot_performance + theme(legend.position = "none") 

start_year <- "11,500"
source(file.path(wd, "manuscript", "processing", "suppmat", "model_simulations_from11500.R"))
model_performance_withmig$clim_hpv_sorensen.mean <- 1-model_performance_withmig$clim_hpv_sorensen.mean # dissimilarity
source(file.path(wd, "manuscript", "figs", "suppmat", "figS15", "boxplot_performance.R"))
...
```{r different_initial_refugia, fig.height = 130, fig.width = 190, dev=c('cairo_pdf'), eval = F}
