...
```{r climatic_dissimilarity_and_distance, fig.height = 90, fig.width = 200, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Climatic dissimilarity vs climatic distance.", eval = F}
source(file.path(wd, "manuscript", "figs", "suppmat", "figA3.R"))
figA3_main
```


```{r migration_process, fig.height = 100, fig.width = 180, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Illustration of Q. deciduous migration process. PHENOFIT (fitted) from 12000BP. + Evaluation of the impact of migration process stochasticity on model performance.", eval = F}
source(file.path(wd, "manuscript", "figs", "suppmat", "figA4.R"))

source(file.path(wd, "manuscript", "figs", "suppmat", "figA16.R"))

plot_grid(figA4_main , figA16_main, ncol = 2, 
...
```{r performance_perspecies, fig.height = 130, fig.width = 150, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance per species per type of model.", eval = T}
source(file.path(wd, "manuscript", "figs", "suppmat", "figA8.R")) 
figA8_main
```

```{r performance_perspecies_permodel, fig.height = 130, fig.width = 150, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance per species per model.", eval = T}
source(file.path(wd, "manuscript", "figs", "suppmat", "figA9.R")) 
figA9_main
```

```{r current_performance, fig.height = 65, fig.width = 140, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Current performance", eval = T}

source(file.path(wd, "manuscript", "figs", "suppmat", "figA14.R")) 
figA14_main
```

```{r performance_time, fig.height = 85, fig.width = 110, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance against time.", eval = T}
...
```{r performance_perspeciesmigration, fig.height = 100, fig.width = 195, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance per species per type of model.", eval = T}
source(file.path(wd, "manuscript", "figs", "suppmat", "figA12.R")) 
figA12_main
```

```{r past_performance_womigration, fig.height = 120, fig.width = 190, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Beta regression and boxplots. Without migration.", eval = T}
...
```{r past_performance_from12000, fig.height = 120, fig.width = 190, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Beta regression and boxplots", eval = T}
...
```{r past_performance_differentstarts, fig.height = 240, fig.width = 180, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Beta regression and boxplots", eval = T}
