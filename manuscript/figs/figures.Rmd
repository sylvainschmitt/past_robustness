...
```{r climatic_dissimilarity_and_distance, fig.height = 90, fig.width = 210, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Climatic dissimilarity vs climatic distance.", eval = T}
...
```{r current_performance, fig.height = 85, fig.width = 110, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance against time.", eval = T}
