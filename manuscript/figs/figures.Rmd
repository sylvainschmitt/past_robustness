...
```{r migration_process, fig.height = 100, fig.width = 180, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Illustration of Q. deciduous migration process. PHENOFIT (fitted) from 12000BP. + Evaluation of the impact of migration process stochasticity on model performance.", eval = T}
