...
```{r quercus_deciduous_simulations, fig.height = 240, fig.width = 150, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Example of paleosimulations obtained with the eight models used in this study for deciduous oaks.", eval = F}
...
```{r past_performance_wtime, eval = T}
...
```{r past_performance_nomigration, eval = T}
...
```{r past_performance_from11750, fig.height = 120, fig.width = 190, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Beta regression and boxplots", eval = T}
...
```{r figS10_past_performance_summary, fig.height = 240, fig.width = 180, dev=c('cairo_pdf'), dpi = 600, fig.cap = "Performance of correlative models, fitted process-based models (inverse calibration using occurrence data) and expert process-based models (classical calibration).", eval = T}
