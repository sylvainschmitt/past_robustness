...
ordbetareg_plot <- ggplot(data = expected_predictions, aes(y=Estimate.migsorensen,x=clim_hpv_sorensen.mean, col = type, fill = type)) +
  ...
  annotate("rect", xmin = 0.297, xmax = 0.343, ymin = 0, ymax = 1, alpha = .7, fill = "white") + # white shade
  annotate("rect", xmin = 0.343, xmax = 0.351, ymin = 0, ymax = 1, alpha = 1, fill = "white") +
