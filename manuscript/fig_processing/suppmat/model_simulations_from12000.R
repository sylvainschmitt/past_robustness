...
fagus_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/fagus_sylvatica_expandLDD_scprb_2km20km_fullmodel_from12000"),
...
abies_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/abies_alba_expandLDD_scprb_2km20km_fullmodel_from12000"),
...
quercusdeciduous_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/quercus_deciduous_expandLDD_scprb_2km20km_fullmodel_from12000"),
...
quercusevergreen_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/quercus_evergreen_expandLDD_scprb_2km20km_fullmodel_from12000"),
