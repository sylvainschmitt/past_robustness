...
abies_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/abies_alba_expandLDD_scprb_2km20km_fullmodel_from11750"),
...
quercusdeciduous_models <- data.frame(
  ...
  simfolder = c(
    ...
    paste0(wd, "/data/simulations/migration/csdm/maxent/quercus_deciduous_expandLDD_scprb_2km20km_fullmodel_from11750"),
